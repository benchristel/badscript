module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c21 = "but",
        peg$c22 = { type: "literal", value: "but", description: "\"but\"" },
        peg$c23 = "when",
        peg$c24 = { type: "literal", value: "when", description: "\"when\"" },
        peg$c25 = "else",
        ...
        peg$c35 = function(condition, alternative) {
          return {
            condition: condition,
            alternative: alternative,
            negated: false
        ...
        peg$c36 = function(condition, alternative) {
          return {
            condition: condition,
            alternative: alternative,
            negated: true
        ...
        peg$c37 = function(cases, elseCase) {
          return {
            type: 'CaseExpression',
            cases: cases,
            elseValue: elseCase
        ...
        peg$c68 = function(maybeParams, body, localNames) {
        ...
        peg$c72 = function(i, defaultValue) {
          return {
            type: 'Parameter',
            name: i.name,
    ...
    function peg$parseConditionedExpression() {
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s1 !== peg$FAILED) {
          ...
          s4 = peg$parseSpace();
          if (s4 !== peg$FAILED) {
            s5 = peg$parsePipeableExpression();
            if (s5 !== peg$FAILED) {
              s4 = [s4, s5];
              s3 = s4;
            } else {
